    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <View style={styles.navGrid}>
        <NavCard
          icon="photos"
          label="Photos"
          onPress={() => router.push(`/(admin)/(more)/properties/${id}/photos`)}
        />
        <NavCard
          icon="checklists"
          label="Checklists"
          onPress={() => router.push(`/(admin)/(more)/properties/${id}/checklists`)}
        />
        <NavCard
          icon="instructions"
          label="Standing Instructions"
          onPress={() => router.push(`/(admin)/(more)/properties/${id}/instructions`)}
        />
        <NavCard
          icon="preferences"
          label="Owner Preferences"
          onPress={() => router.push(`/(admin)/(more)/properties/${id}/owner-preferences`)}
        />
      </View>
    </ScrollView>
  );
